...
config.runtimeDataModel = JSON.parse("{\"models\":{\"Kategori\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"Int\"},{\"name\":\"nama\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"nama_filter\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"},{\"name\":\"updatedAt\",\"kind\":\"scalar\",\"type\":\"DateTime\"}],\"dbName\":null}},\"enums\":{},\"types\":{}}")
config.parameterizationSchema = {
  strings: JSON.parse("[\"where\",\"Kategori.findUnique\",\"Kategori.findUniqueOrThrow\",\"orderBy\",\"cursor\",\"Kategori.findFirst\",\"Kategori.findFirstOrThrow\",\"Kategori.findMany\",\"data\",\"Kategori.createOne\",\"Kategori.createMany\",\"Kategori.createManyAndReturn\",\"Kategori.updateOne\",\"Kategori.updateMany\",\"Kategori.updateManyAndReturn\",\"create\",\"update\",\"Kategori.upsertOne\",\"Kategori.deleteOne\",\"Kategori.deleteMany\",\"having\",\"_count\",\"_avg\",\"_sum\",\"_min\",\"_max\",\"Kategori.groupBy\",\"Kategori.aggregate\",\"AND\",\"OR\",\"NOT\",\"id\",\"nama\",\"nama_filter\",\"createdAt\",\"updatedAt\",\"equals\",\"in\",\"notIn\",\"lt\",\"lte\",\"gt\",\"gte\",\"not\",\"contains\",\"startsWith\",\"endsWith\",\"set\",\"increment\",\"decrement\",\"multiply\",\"divide\"]"),
